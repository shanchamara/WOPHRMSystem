...
namespace WOPHRMSystem.Services
{
    public class PartnerServices
    {
        ...
        public TblPartner GetByName(string code)
        {
            return _context.TblPartners.SingleOrDefault(d => d.Code.Equals(code));
        }

        public MessageModel Insert(TblPartner obj)
        {
        ...
        public TblPartner GetById(int Id)
        {
            return _context.TblPartners.SingleOrDefault(i => i.Id == Id);
        }


        public MessageModel Update(TblPartner obj)
        {
            try
            {
        ...
        public MessageModel Delete(TblPartner obj)
        {
            try
            {
                var dbobj = GetById(obj.Id);
        ...
        public List<PartnerModel> GetAll()
        {
            try
            {
                var dr = (from a in _context.TblPartners
