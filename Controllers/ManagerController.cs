...
namespace WOPHRMSystem.Controllers
{
    ...
    {
        readonly ManagerServices _ClientService = new ManagerServices();
        ...
        [HttpPost]
        public ActionResult Create(ManagerModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    TblManager tbl = new TblManager();
                    {
        ...
        [HttpPost]
        public ActionResult Edit(ManagerModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
