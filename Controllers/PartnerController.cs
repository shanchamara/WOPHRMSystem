...
namespace WOPHRMSystem.Controllers
{
    ...
    {
        readonly PartnerServices _ClientService = new PartnerServices();
        ...
        [HttpPost]
        public ActionResult Create(PartnerModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    TblPartner tbl = new TblPartner();
                    {
        ...
        [HttpPost]
        public ActionResult Edit(PartnerModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
