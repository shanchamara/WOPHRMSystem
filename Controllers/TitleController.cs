...
namespace WOPHRMSystem.Controllers
{
    ...
    {
        readonly TitleServices _ClientService = new TitleServices();
        ...
        {
            var model = new TitleModel() { IsActive = true };
            return View("Create", model);
        }

        [HttpPost]
        public ActionResult Create(TitleModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    TblTitle tbl = new TblTitle();
                    {
        ...
        [HttpPost]
        public ActionResult Edit(TitleModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
